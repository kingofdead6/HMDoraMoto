...
const translations = {
  fr: {
    ...
    adminProducts: {
      ...
      imageSection: "Images",
      imageHint: "8 images maximum, 5 Mo par image.",
      cancel: "Annuler",
      save: "Enregistrer",
      ...
      maxImages: "8 images maximum — il ne reste que {count} emplacement(s).",
      maxImagesReached: "8 images maximum atteintes.",
  ...
  ar: {
    ...
    adminProducts: {
      ...
      imageSection: "الصور",
      imageHint: "8 صور كحد أقصى، 5 ميغابايت لكل صورة.",
      cancel: "إلغاء",
      save: "حفظ",
      update: "تحديث",
      create: "إنشاء",
      ...
      maxImages: "الحد الأقصى 8 صور — تبقى {count} خلية(خلات).",
      maxImagesReached: "تم الوصول إلى الحد الأقصى 8 صور.",
