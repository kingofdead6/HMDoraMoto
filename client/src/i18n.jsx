...
const translations = {
  fr: {
    ...
    adminProducts: {
      ...
      visibilityMandatorySpecs: "Certaines caractéristiques obligatoires sont manquantes (Vitesse max, Autonomie, Puissance, Temps de charge).",
      modalTitleNew: "Nouveau produit",
      modalTitleEdit: "Modifier le produit",
      modalSubtitle: "Remplissez les champs ci-dessous — les caractéristiques obligatoires sont au début.",
      ...
      addFeature: "Ajouter une fonctionnalité personnalisée",
      imageSection: "Images",
  ...
  ar: {
    ...
    adminProducts: {
      ...
      visibilityMandatorySpecs: "بعض المواصفات الإجبارية مفقودة (السرعة القصوى، المدى، الاستطاعة، وقت الشحن).",
      modalTitleNew: "منتج جديد",
      modalTitleEdit: "تعديل المنتج",
      modalSubtitle: "املأ الحقول أدناه — الخصائص الإجبارية موجودة في الأعلى.",
